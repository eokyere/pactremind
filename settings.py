...
ADMINS = (
    ('Slawa Rokicki', 'slawa.rokicki@gmal.com'),
    ('Emmanuel Okyere', 'chief@hutspace.net'),
)
...
SECRET_KEY = '0c)jgx+y^wh#c*e#9p5k6aw95#!5@a6qsd)@z@6n$2q+m_-+5*'
